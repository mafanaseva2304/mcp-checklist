from numpy import ndarray, nansum, log, exp
from pandas import DataFrame, Series
from typing import Union
from app.models import Model


class C40_ONPZmodel(Model):
    """
    C40_ONPZ- Вязкость при 40°C (ОНПЗ)
    """
    def predict(self, data: Union[DataFrame, ndarray]):
        ...
        if type(data) == DataFrame:
            ...
            return_list = (exp(exp((weight_sum-10.975)/14.535))-0.8 + self.intercept_)
