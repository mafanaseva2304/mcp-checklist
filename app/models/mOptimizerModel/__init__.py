...
from app.models.mOptimizer import OptimizerMixing
...
class OptimizerModel(Model):
    ...
    def predict(self, data: ndarray):
        ...
        if self.target_name == 1:  # Target function - off_spec__giveaway (Регулировка свойств - Минимальная отдача по качеству)

            self.optimizer.load(func_type='off_spec__giveaway',
        ...
        elif self.target_name == 2:  # Target function - off_spec__price (Регулировка свойств - Минимальная цена)

            self.optimizer.load(func_type='off_spec__price',
                           min_quality_product=self.min_quality_product,
                           max_quality_product=self.max_quality_product,
                           min_flow=self.min_flow,
                           max_flow=self.max_flow,
        ...
        elif self.target_name == 3:  # Target function - off_spec__price__giveaway (Регулировка свойств - Минимальная цена - Минимальная отдача по качеству)

            self.optimizer.load(func_type='off_spec__price__giveaway',
                           min_quality_product=self.min_quality_product,
                           max_quality_product=self.max_quality_product,
                           min_flow=self.min_flow,
                           max_flow=self.max_flow,
        ...
        elif self.target_name == 4:  # Target function - off_spec__giveaway__price (Регулировка свойств - Минимальная отдача по качеству - Минимальная цена)

            self.optimizer.load(func_type='off_spec__giveaway__price',
                           min_quality_product=self.min_quality_product,
                           max_quality_product=self.max_quality_product,
                           min_flow=self.min_flow,
                           max_flow=self.max_flow,
        ...
        elif self.target_name == 5:  # Target function - off_spec__variance (Регулировка свойств - Минимальное отклонение)

            self.optimizer.load(func_type='off_spec__variance',
                           min_quality_product=self.min_quality_product,
                           max_quality_product=self.max_quality_product,
                           min_flow=self.min_flow,
                           max_flow=self.max_flow,
