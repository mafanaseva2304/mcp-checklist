...
class FLS_ONPZmodel(Model):
    """
    FLS_ONPZ- Т.Вспышки, °С (ОНПЗ)
    """
    def predict(self, data: Union[DataFrame, ndarray]):
        ...
        if type(data) == DataFrame:
            ...
            d_q_transformed = power(10,(42.1093-14.286*log10(d_q/5*9+32+460)))
            d_fr[d_fr < 1] = 0
            weight_sum = (nansum(d_q_transformed * d_fr, axis=1) / nansum(d_fr, axis=1))
            return_list = (5/9*(power(10,(42.1093-log10(weight_sum))/14.289)-492) + self.intercept_)
