...
class ModelsHealthTools:
    ...
    def register(self) -> None:
        ...
        @mcp.tool(description="Проверка соответствия количества предикторов в бинарнике и конфигурации")
        ...
        #@mcp.tool(description="Тестовый метод d (заглушка)")
        #async def d() -> Dict[str, Any]:
        #    return (await svc.d()).model_dump()
        ...
        @mcp.tool(description="Поиск моделей с неизменяющимися значениями за последний час")
